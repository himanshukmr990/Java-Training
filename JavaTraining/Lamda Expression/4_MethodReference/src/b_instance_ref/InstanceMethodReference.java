...
public class InstanceMethodReference {	
	...
	public static void main(String[] args) {
		...
		Collections.sort(people, (p1,p2)->new Comp().compareAges(p1, p2));  // using compareAges() 

    	 // Method reference
          Collections.sort(people, new Comp()::compareNames);  // // using method ref for compareAges 		 
