...
public class ObtainStreams {
	...
	public static void main(String[] args) throws Exception{  
	   ...
	   "Hello India".chars().forEach(x -> System.out.println(Character.toChars(x)));
